      ...
      <div className="min-h-screen gradient-green flex flex-col items-center justify-center relative overflow-hidden" dir={isRTL ? 'rtl' : 'ltr'}>
        ...
        <div className="relative z-10 flex flex-col items-center text-center px-8">
          ...
          <button
            ...
            className="bg-white text-green-700 font-black py-4 px-14 rounded-2xl text-lg card-shadow-lg hover:bg-green-50 transition-all active:scale-95"
          >
            {isRTL ? '🚀 ابدأ الآن' : '🚀 Get Started'}
          </button>

          <p className="text-green-200/70 text-xs mt-6">
  ...
  if (view === 'login') {
    return (
      <div className="min-h-screen bg-gray-50 flex flex-col" dir={isRTL ? 'rtl' : 'ltr'}>
        {/* Header */}
        <div className="gradient-green px-6 pt-12 pb-20 text-center relative overflow-hidden">
        ...
        <div className="flex-1 px-6 -mt-10 pb-8">
          {!loginType ? (
  ...
  if (view === 'customer-home') {
    return (
      <div className="min-h-screen bg-gray-50 pb-20" dir={isRTL ? 'rtl' : 'ltr'}>
        {/* Hero Header */}
        <div className="gradient-green px-6 pt-12 pb-24 relative overflow-hidden">
