  ...
  if (view === 'login') {
    return (
      <div className="min-h-screen bg-gray-50 flex flex-col" dir={isRTL ? 'rtl' : 'ltr'}>
        {/* Header */}
        <div className="gradient-green px-4 pt-1 pb-1 text-center relative overflow-hidden">
        ...
        <div className="flex-1 px-4 -mt-20 pb-2">
          {!loginType ? (
  ...
  if (view === 'customer-home') {
    return (
      <div className="min-h-screen bg-gray-50 pb-20" dir={isRTL ? 'rtl' : 'ltr'}>
        {/* Hero Header */}
        <div className="gradient-green px-6 pt-4 pb-10 relative overflow-hidden">
