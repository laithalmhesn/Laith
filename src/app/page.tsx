  ...
  if (view === 'splash') {
    return (
      <div className="min-h-screen gradient-green flex flex-col items-center justify-center relative overflow-hidden" dir={isRTL ? 'rtl' : 'ltr'}>
        ...
        <div className="relative z-10 flex flex-col items-center text-center px-4 pt-4">
          {/* Logo */}
  ...
  if (view === 'login') {
    return (
      <div className="min-h-screen bg-gray-50 flex flex-col" dir={isRTL ? 'rtl' : 'ltr'}>
        {/* Header */}
        <div className="gradient-green px-6 pt-3 pb-3 text-center relative overflow-hidden">
        ...
        <div className="flex-1 px-6 -mt-8 pb-4">
          {!loginType ? (
